...
//           consultation_days: (res.data.available_days || []).map((d) => d), // IDs or labels; adjust later if needed
//         });
//       } catch (e) {
...
//         // Map selected consultation_days (strings) to availability IDs on backend later
//       };
...
//       setIsEditing(false);
//     } catch (e) {
//       console.error("Failed to save consultant profile", e);
